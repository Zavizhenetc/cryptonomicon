...
export default {
  ...
  methods: {
    add() {
      ...
      setInterval(async () => {
        const f = await fetch(`https://min-api.cryptocompare.com/data/price?fsym=${currentTicker.name}&tsyms=USD&api_key=143cc51101facbc2102cbdb45f2decd9569598b0d94158233c8ca10cbdc84eef`)
